...
#define GPMC_MEM_START		0x10000000
#define GPMC_MEM_END		0x4FFFFFFF
...
static int gpmc_cs_insert_mem(int cs, unsigned long base, unsigned long size)
{
	...
	res->start = base + GPMC_MEM_START;
	res->end = base + size - 1 + GPMC_MEM_START;
...
static void __init gpmc_mem_init(void)
{
	...
	/* In dhcm3517 the CS0 is mapped as 0x0000 0000, but
	 * this does not work, we have changed the GPMC START ADR
	 * to 0x10000000 */
	if (machine_is_dhcm3517())
		boot_rom_space = 0;
	/* this is true for dham35xmedeacc, too */
	if (machine_is_dham35xmedeacc())
		boot_rom_space = 0;
	/* this is true for dham35xcfi2, too */
	if (machine_is_dham35xcfi2())
		boot_rom_space = 0;
