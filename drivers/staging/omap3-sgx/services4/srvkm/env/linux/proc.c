...
static void ProcSeqShowVersion(struct seq_file *sfile,void* el)
{
	SYS_DATA *psSysData;
#if SGX_CORE_REV == 103
	IMG_CHAR *pszSystemVersionString = "SGX revision = 1.0.3" ;
#endif
#if SGX_CORE_REV == 121
	IMG_CHAR *pszSystemVersionString = "SGX revision = 1.2.1" ;
#endif
#if SGX_CORE_REV == 125
	IMG_CHAR *pszSystemVersionString = "SGX revision = 1.2.5" ;
#endif
